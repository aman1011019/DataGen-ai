  ...
  return (
    <div className="min-h-screen bg-background flex flex-col justify-center py-12 sm:px-6 lg:px-8 selection:bg-primary/20">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center space-y-3">
        ...
        <p className="text-xs text-muted-foreground">Access your synthetic dataset workspace and schemas</p>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <Link to="/forgot-password" className="text-primary hover:underline text-[11px]">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
